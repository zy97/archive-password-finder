...
impl Iterator for PasswordGenerator1 {
    type Item = String;
...
pub fn password_generator_iter(
    ...
    PasswordGenerator1::new(charset.clone(), min_size, max_size, progress_bar)
}
...
mod tests {
    use crate::{
        charsets::{
            charset_digits, charset_lowercase_letters, charset_punctuations,
            charset_uppercase_letters,
        },
        password_gen::PasswordGenWorker,
    };
